...
target_path = sys.argv[1] #target path from cron job for example: "-C /home/thko1/ops445/a2 things"
dest_path = f"{sys.argv[2]}" #destination path for example: "/home/thko1/ops445/backup/"
